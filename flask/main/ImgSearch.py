...
class ImageSearch:
  ...
  def searchpart(self):
    ...
    trim_img_path = self.make_image(msg, rendering_time, font_list, img_save_path)

    self.trim(trim_img_path)
    print("2. 텍스트 렌더링 완료")
